const edd_debit_card_fees = (
  <div className="article-div">
    <h4>Will I Be Charged Fees to Use My EDD Debit Card?</h4>
    <p>
      ...
      purchase, without a fee. You can get cash from ATMs and from tellers
      at banks and credit unions that accept Visa® cards; however, fees
      may apply after you exceed the number of free transactions.
    </p>
    ...
    <p>
      ...
      information, visit{" "}
      <a href="http://www.edd.ca.gov/about_edd/the_edd_debit_card.htm">
      The EDD Debit Card
      </a>{" "}
      page.
    </p>
    <p>
      ...
      the EDD nor Bank of America will contact you under any circumstances
      to request your EDD Debit Card account number and/or PIN. If you are
      contacted by phone or email and asked for the information, DO NOT
      respond. Any direct deposit transfer request must be initiated by
      you through Bank of America.
    </p>
  </div>
);

export default edd_debit_card_fees;