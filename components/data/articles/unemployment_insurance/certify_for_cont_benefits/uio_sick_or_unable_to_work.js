...
export default function uio_sick_or_unable_to_work() {
  return(
    <div className="article-div">
      <h4>Sick or Unable to Work</h4>
      <p>
            Eligibility for Unemployment Insurance requires that you be
            physically able, available and searching for full-time employment in
      ...
      <p>
            ...
            question #1. Your weekly benefits will be reduced by one seventh for
            every day you are unable to work. If you are unable to work due to
            illness or injury for more than seven days, be sure to report this
            on your claim form and consider filing for Disability Insurance
            benefits.
      </p>
      <p>
      ...
      <p><UIOnlineLink />: Manage your claim 24 hours a day, seven days a week through UI
      OnlineSM. <RegisterLink /> or log in to your <UIOnlineLink /> to:</p>
      <ul>
