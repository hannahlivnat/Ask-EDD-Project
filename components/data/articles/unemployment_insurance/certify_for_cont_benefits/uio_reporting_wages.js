...
export default function uio_reporting_wages() {
  return(
    <div className="article-div">
      <h4>Reporting Wages While Certifying for Continued Benefits</h4>
      <p>
            ...
            accurately to prevent an overpayment. The EDD has a fraud detection
            system. If you do not report all earnings for a week when you
            worked, and you received benefits, you will be investigated. If the
            EDD determines that you were at fault for not reporting your
            earnings, you will be required to repay any benefits overpaid and
            you could face administrative and/or criminal penalties and
            interest.
      </p>
      <p>
            Report the gross wages (earnings before deductions) you earned from
            employment, residuals, commissions and self-employment earnings
            regardless of the method you use to certify for your benefits. The
            EDD will calculate the deductions. Remember to report your wages
            during the week you earn them, NOT WHEN THEY ARE PAID TO YOU.
      </p>
      <p>
      ...
      <p><UIOnlineLink />: Manage your claim 24 hours a day, seven days a weekly 
      through UI OnlineSM. <RegisterLink /> or log in to your <UIOnlineLink /> account to: </p>
      <ul>
