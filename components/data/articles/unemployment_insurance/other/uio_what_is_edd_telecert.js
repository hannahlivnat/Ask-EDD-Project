...
export default function uio_edd_telecert() {
  return(
    <div className="article-div">
      ...
      Tele-CertSM including the ability to report work and wages when you
      submit your certification. You can also update your contact
      ...
      over the phone by calling the UI Self-Service Phone Line,
        <b>
      1-866-333-4606. It is recommended that you call after 12 noon
      and before 8:00 a.m., Monday through Friday, Pacific Time, or
      anytime on Saturday and Sunday.
        </b>
      </p>
      <p>
      The questions asked when using UI OnlineSM are the same questions on
      the paper Continued Claim Form (DE 4581).
      </p>
    </div>
  )
}