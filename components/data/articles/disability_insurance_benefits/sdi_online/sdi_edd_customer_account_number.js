...
export default function sdi_edd_customer_account_number() {
  <Article h4="EDD Customer Account Number (EDDCAN)">
    <p>
          ...
          complete your SDI Online registration. It will initially appear in a
          message on the Successful Account Creation Notification section of the
          Account Setup Confirmation page. This number will help limit the use
