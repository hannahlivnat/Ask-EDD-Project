export default function payroll_wage_history() {
  return (
    <div className="article-div">
      ...
      <p>
        <b>Note</b>: If this request is from a third party, you must
                also include a written authorization signed and dated from the
                account owner stating that they allow the EDD to share wage
                history information.
      </p>
      <p>Mail to:</p>
      ...
      <p>
                You can also fax your request to 1-916-449-1994, Attn: Wage
                History Request.
      </p>
    </div>
  );
